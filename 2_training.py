...
DATA_PATH = BASE_DIR / "data" / "Main_Parameters(2020-2024).xlsx"
...
# SAVE MODELS
# =========================================
joblib.dump(model_t1, MODELS_DIR / "model_t1.pkl")
joblib.dump(model_t2, MODELS_DIR / "model_t2.pkl")
joblib.dump(model_t3, MODELS_DIR / "model_t3.pkl")
