...
import { SiFastapi, SiXgboost, SiTailwindcss } from "react-icons/si";
...
function About() {
  const technologies = [
    ...
    {
      name: "XGBoost",
      icon: <SiXgboost className="text-orange-500 text-3xl" />,
    },
    {
      name: "Tailwind CSS",
      ...
      <section>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-white rounded-3xl shadow-lg p-8 hover:-translate-y-1 transition"
            >
              <div className="mb-6">
                {feature.icon}
              </div>
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          ...
          {technologies.map((tech, index) => (
            <div
              key={index}
              className="bg-white rounded-3xl shadow-lg p-8 flex flex-col items-center hover:-translate-y-1 transition"
            >
              {tech.icon}
